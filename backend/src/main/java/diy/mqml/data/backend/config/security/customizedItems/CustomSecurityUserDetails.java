...
@Getter
@Setter
public class CustomSecurityUserDetails implements UserDetails, Authentication, CredentialsContainer {

    protected AppSecurityUser user;
    protected List<? extends GrantedAuthority> authorities;
    protected boolean authenticated = false;

    public CustomSecurityUserDetails(AppSecurityUser user, Collection<? extends GrantedAuthority> authorities) {
        this.user = user;
    ...
    public List<? extends GrantedAuthority> assignAuthorities(List<String> roles) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof CustomSecurityUserDetails that)) return false;
